...
class MBERTSarcasmDetector(nn.Module):
    def __init__(self, pretrained_model_name="bert-base-multilingual-cased"):
        super(MBERTSarcasmDetector, self).__init__()
    ...
    def create_and_prepare_model(
        pretrained_model_name="bert-base-multilingual-cased", device="cuda"
    ):
        base_model = AutoModel.from_pretrained(pretrained_model_name)
        model = MBERTSarcasmDetector(pretrained_model_name)
